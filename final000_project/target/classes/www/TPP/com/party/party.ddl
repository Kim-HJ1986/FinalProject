drop table f_seller_info;
drop table f_party;
--party_type, description
--커밋을 생활화합시다!!!!!!!!!

create table f_authority(
	authority_type		char(10),
...
create table f_party(
	...
	user_pwd 		varchar2(30) 	not null,	--100 : 암호화된 결과물까지 고려함
	user_name 		varchar2(50) 	not null,	--100 : 전지구적인 사람의 이름 길이까지 고려함
...
create table f_seller_info (
	business_reg_num		varchar2(12)		primary key,
	user_id					varchar2(10)		references f_party(user_id),
	business_name			varchar2(50)		not null,
	business_phone_num		varchar2(13)
);
