...
public class ClassAnalyzer {
	...
	public static List<AccessibleObject> findAllFeature(Class targetClass) {
		...
		findAllFeature(targetClass, ret);
		return ret;
	}
	...
	private static void findAllFeature(Class targetClass, List<AccessibleObject> ret) {
		if (targetClass == null)
			return;
		try {
		...
		findAllFeature(targetClass.getSuperclass(), ret);
	}
}
