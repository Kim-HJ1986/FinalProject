...
public class ReplyController {
	...
	public ResponseEntity<List<PptForSaleVO>> getReplyListWithPaging(@PathVariable("originalId") String originalId,
			@PathVariable("page") int page) {
		Criteria cri = new Criteria();
		cri.setPageNumber(page);

		return new ResponseEntity<>(pptForSaleService.getReplyListWithPaging(originalId, cri), HttpStatus.OK);
	}
