            ...
            <div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="login-box" style="background-color: skyblue; padding-left: 5px;">
						<a href="http://localhost:8080/party/regist" style="color: white;">회원가입</a>
						<a href="http://localhost:8080/party/login" style="color: white;">로그인</a>
					</div>
					</c:if>
					<!-- 로그인한 상태 -->
	                <c:if test="${loginParty != null}">
		                <div class="login-box" style="background-color: skyblue; padding-left: 10px;">
		                    <div class="login_success_area">
		                        <span>아이디 : ${loginParty.userId}</span>
		                        <span>회원 : ${loginParty.userName}</span>
		                        <span>권한 : ${loginParty.authority}</span>
