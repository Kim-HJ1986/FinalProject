...
public interface PostMapper {
	...
	public long getPostTotalCountBySearchingWithUserId(@Param("criteria") Criteria criteria, @Param("userId") String userId);
	...
	public List<PostVO> getPostListBySearchingWithUserId(@Param("criteria") Criteria criteria, @Param("userId") String userId);
