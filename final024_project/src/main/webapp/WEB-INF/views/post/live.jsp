    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <li>안드로이드 Remon Call Kit에 로그인을 합니다. </li>
                <li>로그인이 됐다면 왼족의 학생 리스트에 뜨게 됩니다.</li>
                <br/>
                <li>로그인시 서버에 푸시주소가 발행되며, DB에서 관리합니다.</li>
                <li>학생을 선택해서 누르게 되면, 해당 학생에게 전화를 걸게 됩니다.</li>
                <li>해당 학생의 앱에서 전화를 수락하면 통화가 시작됩니다.</li>
                <li class="text-danger">통화의 Channle ID 는 랜덤하게 생성됩니다.</li>
                <br>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="card shadow mb-4">
                            <!-- Card Header - Dropdown -->
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">수업 화면</h6>
                            </div>
                            <!-- Card Body -->
                            <div class="card-body">
