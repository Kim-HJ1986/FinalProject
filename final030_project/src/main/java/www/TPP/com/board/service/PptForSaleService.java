...
//###################################################reply관련####################################################################
	...
	public Quad<Criteria, Criteria, List<PptForSaleVO>, List<PptForSaleVO>> getReplyListWithPaging(Criteria reviewCri, Criteria qnaCri, String originalId){
		...
		String forreview = "22222";
		String forqna = "11111";
		String reviewId = originalId + forreview;
		String qnaId = originalId + forqna;
		...
		Quad<Criteria, Criteria, List<PptForSaleVO>, List<PptForSaleVO>> ret = new Quad<>(reviewCri, qnaCri, reviewList, qnaList);
		return ret;
	}
