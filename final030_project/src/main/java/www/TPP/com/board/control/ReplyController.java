...
public class ReplyController {
	...
	public ResponseEntity<Quad<Criteria, Criteria, List<PptForSaleVO>, List<PptForSaleVO>>> getReplyListWithPaging(
			@PathVariable("originalId") String originalId, @PathVariable("reviewPage") int reviewPage, @PathVariable("qnaPage") int qnaPage) {
		...
		Quad<Criteria, Criteria, List<PptForSaleVO>, List<PptForSaleVO>> ret = pptForSaleService.getReplyListWithPaging(reviewCri, qnaCri, originalId);
