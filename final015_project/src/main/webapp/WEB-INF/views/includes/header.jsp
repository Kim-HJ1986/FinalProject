                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="text-slid-box">
                        <div id="offer-box" class="carouselTicker">
                            <ul class="offer-box">
                                <li>
                                    <i class="fab fa-opencart"></i> 20% 할인 쿠폰 코드 : tpT22334
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/post/managementProduct?boardId=2&sellerId=seller2">베스트</a></li>
                        <li class="nav-item"><a class="nav-link" href="/post/managementProduct?boardId=3&sellerId=seller2">라이브</a></li>
                        <li class="nav-item"><a class="nav-link" href="/post/managementProduct?boardId=4&sellerId=seller2">마이페이지</a></li>
                        <li class="nav-item"><a class="nav-link" href="/post/managementProduct?boardId=5&sellerId=seller2">상품 관리</a></li>
                        <li class="nav-item"><a class="nav-link" href="/post/managementProduct?boardId=6&sellerId=seller2">관리페이지</a></li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
