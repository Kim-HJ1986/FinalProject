		...
		<div class="card-body">
			<form  id="frmPost" action="/post/modifyPost" method="post">
				<div>
					...
					<div class="form-group">
						<label>게시글 제목</label> 
						<input name="postTitle" value="${post[0].postTitle}" class="modi" readonly>
					</div>
					<div class="form-group">
						<label>상품명</label> 
					...
					<div class="form-group">
						<label>상세 정보</label>
						<input id="postInfoContent" name="postInfoContent" value="${postInfoList[0].postInfoContent}" class="modi" readonly>
					</div>
