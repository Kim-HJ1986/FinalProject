	...
	<div class="card shadow mb-4">
		...
		<div>
			...
			<div class="form-group">
				<label>게시글 제목</label> <input name="location" value="${post[0].postTitle}" class="form-control" readonly>
			</div>
			<div class="form-group">
		...
		<body>
			...
			<div id="divQnA">
				<!-- "../product/product.jsp" -->
				<div class="form-group">
					<label>아이디</label> <input name="id" value=""
						class="form-control" readonly>
				</div>
				<div class="form-group">
					<label>문의 내용</label> <input name="title"
			...
			<div id="divReview">
				...
				<div class="form-group">
					<label>후기</label> <input name="title"
						value="" class="form-control" readonly>
				</div>
			</div>
		</body>
