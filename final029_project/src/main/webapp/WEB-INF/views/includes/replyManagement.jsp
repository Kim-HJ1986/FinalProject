...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
		...
		<div class="card-footer" id="divQnA">
			...
			<!-- 페이징 처리 -->
			<div id="replyQnAPaging" class='fa-pull-right'>
			</div>
		</div>
		...
		<div class="card-footer" id="divReview">
			...
			<!-- 페이징 처리 -->
			<div id="replyReviewPaging" class='fa-pull-right'>
			</div>
		</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label>작성자</label> 
					<input class="form-control" name='QnAreplyer' value='' readonly>
				</div>
				<div class="form-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label>작성자</label> 
					<input class="form-control" name='Reviewreplyer' value='' readonly>
				</div>
				<div class="form-group">
					<label>Reply Date</label> 
